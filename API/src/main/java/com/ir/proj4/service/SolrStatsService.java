...
//        System.out.println(response);
        ...
        url = "http://18.191.170.212:8983/solr/IRF18P1/select?indent=true&deftype=edismax&facet.field=city&facet.field=hashtags&facet.field=topic&facet.field=verified&facet.field=lang&facet=on&qf=text&q="+q3+"&fl=text%2Ctweet_date%2Ccity&rows="+obj_QueryData.getResponse().getNumFound()+"&wt=json";

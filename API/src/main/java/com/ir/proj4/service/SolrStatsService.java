...
public class SolrStatsService {
	...
	public ReturnStatisticsList querySolr(String query, String lang, String topic, String verified, String city)
		...
		url = "http://18.191.170.212:8983/solr/IRF18P1/select?indent=true&deftype=edismax&facet.field=city&facet.field=topic&facet.field=hashtags&facet.field=tweet_date&facet.field=topic&facet.field=verified&facet.field=lang&facet=on&qf=text&q="
